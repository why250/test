...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.config_mgr = ConfigManager(self.inst_mgr, self.log)
        
        # Load instruments from visa.yaml if available
        visa_config = utils.load_yaml_config("config/visa.yaml")
    ...
    def apply_dac_config(self):
        ...
        self.config_mgr.apply_dac_config("config/DAC_Config.csv", dac_alias)

    def apply_power_config(self):
        self.config_mgr.apply_power_config("config/Power_Config.yaml")
